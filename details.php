		...
		<div id="myCarousel" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="./img/samples/poster1.jpg" alt="First slide">
					<div class="carousel-caption">标题 1</div>
				</div>
				<div class="item">
					<img src="./img/samples/poster2.jpg" alt="Second slide">
					<div class="carousel-caption">标题 2</div>
				</div>
				<div class="item">
					<img src="./img/samples/poster1.jpg" alt="Third slide">
	...
	<div class="row">
		<div class="col-xs-3" id="myScrollspy">
			<ul class="nav nav-tabs nav-stacked affix" id="myNav">
				<li class="">
					<a href="#section-1">
						第一部分 <i class="fui-arrow-right"></i>
					</a>
				</li>
				<li class="active">
					<a href="#section-2">
						第二部分 <i class="fui-arrow-right"></i>
					</a>
				</li>
				<li class="">
					<a href="#section-3">
